...
const operations = [
  {
    name: "Upstream Exploration",
    type: "Extraction & Drilling",
    desc: "Advanced deepwater and onshore extraction utilizing state-of-the-art seismic technology for high-yield discovery.",
    image: "https://images.unsplash.com/photo-1542036573-0309b1fefc33?q=80&w=1200&auto=format&fit=crop"
  },
  {
    name: "Midstream Logistics",
    type: "Transport & Storage",
    desc: "Robust global pipeline networks and secure, climate-controlled storage terminals ensuring immediate supply-chain continuity.",
    image: "https://images.unsplash.com/photo-1580975619373-c603125e1a3d?q=80&w=1200&auto=format&fit=crop"
  },
  {
    name: "Downstream Refining",
    type: "Processing & Distillation",
    desc: "Eco-conscious refinement facilities producing high-grade premium fuels and essential petrochemical derivatives.",
    image: "https://images.unsplash.com/photo-1605374465431-294b46c0e5a9?q=80&w=1200&auto=format&fit=crop"
  },
  {
    name: "Future Modalities",
    type: "Sustainable Transition",
    desc: "Strategic long-term investments in biofuels and synthetic alternatives to bridge the gap between today and tomorrow.",
    image: "https://images.unsplash.com/photo-1473341304170-971dccfc26ab?q=80&w=1200&auto=format&fit=crop"
  }
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-24 text-center">
            <FadeIn>
              ...
              <p className="text-white/80 text-lg md:text-xl font-light tracking-wide max-w-2xl mx-auto uppercase">
                Premium Energy Solutions & Logistics
              </p>
            </FadeIn>
          </div>
        </div>
          ...
          <FadeIn delay={200} className="lg:w-1/2 lg:pr-16 z-20 lg:-mr-12 relative lg:mt-32">
            <div className="bg-white p-8 lg:p-16 shadow-2xl border border-gray-100">
              ...
              <h2 className="text-4xl md:text-5xl font-playfair leading-tight mb-8">
                Empowering the future with uncompromising energy.
              </h2>
              <p className="text-xl text-gray-500 font-light leading-relaxed">
                We deliver robust energy solutions prioritizing efficiency, reliability, and unparalleled security of supply. From deep-sea extraction to sustainable transition fuels, HB Oil & Gas sets the standard for modern energy logistics on a global scale.
              </p>
            </div>
          </FadeIn>
        ...
        <div className="mb-32">
          <FadeIn>
            <div className="text-center mb-20">
              ...
              <h2 className="text-4xl md:text-5xl font-playfair mb-6">Strategic Infrastructure</h2>
        ...
        <FadeIn delay={200}>
          <div className="relative py-32 px-8 text-center bg-gray-900 text-white overflow-hidden">
            <div className="absolute inset-0 z-0">
              <Image
                src="https://images.unsplash.com/photo-1542036573-0309b1fefc33?q=80&w=2000&auto=format&fit=crop"
                fill
            ...
            <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
              <span className="text-[#B89D58] text-sm uppercase font-bold tracking-widest mb-6 block">Global Integration</span>
              <h3 className="text-4xl md:text-5xl font-playfair mb-8">Secure your energy supply.</h3>
              <p className="text-white/70 leading-relaxed mb-12 text-lg font-light">
                Discover our wholesale extraction-to-delivery logistics, providing unparalleled access to top-tier commodities across the globe.
              </p>
